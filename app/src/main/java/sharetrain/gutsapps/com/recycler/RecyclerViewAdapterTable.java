...
public class RecyclerViewAdapterTable extends RecyclerView.Adapter<ViewHolderTable> {

    private final OnItemClickListenerTable listener;
    private List<Data> dataList = new ArrayList<Data>();
    private Context context;
    private String codeView;
    public RecyclerViewAdapterTable(List<Data> dataList, Context context, OnItemClickListenerTable listener, String codeView) {
    ...
    public ViewHolderTable onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ViewHolderTable holder = new ViewHolderTable(v);
        return holder;
    }
    ...
    public interface OnItemClickListenerTable {
